var BaynoteJSVersion = "Version: V1139-06";
...
if (bn_locHref.indexOf("https://") == 0) {
    preLoadObj.server = "https://netsuite-www.baynote.net";
} else {
    preLoadObj.server = "http://netsuite-www.baynote.net";
}
preLoadObj.customerId = "netsuite";
preLoadObj.code = "www";
