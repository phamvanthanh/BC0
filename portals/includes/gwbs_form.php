		...
		<form class="short-form" action='' method="post" >
				...
				<div class="col-xs-12">
					...
					<select id="parent-field" name="parent_code" class="form-control" onchange="getVal(this)" >						
								...
								<?php 			
									...
									$sql = "SELECT code, name FROM gwbs WHERE code > 0";
			...
			<div class="form-group">
				<div class="col-xs-12">
					<label>Display:</label>		
					<span class="radio">
						<label class="radio-inline"><input  class="radio-input" type="radio" name="status" value='0' >Yes</label>
