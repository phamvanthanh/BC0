...
<div class="black-bar">
	<nav class="navbar navbar-inverse navbar-fixed-top visible-xs">
		<div class="container">
			<div itemscope itemType="https://schema.org/Service" class="navbar-header" >
	...
	<nav class="navbar navbar-default hidden-xs " >
		<div class="container">
			<div  class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="dropdown" >
						<a class="dropdown-toggle" id="service-menu" href="/construction-trades.php" >Trades</a>			
					</li>
					<li class="dropdown" >
						<a class="dropdown-toggle" id="industry-menu" href="/construction-industries.php" >Industries</a>
					</li>				
					<li class="dropdown" >
