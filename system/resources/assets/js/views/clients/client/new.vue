                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <datepicker 
                                        name="from_date" 
                                        v-model="form.job.from_date"
                                        :min="today"  ></datepicker>             
                                </div>
                            </div>	
                            <div class="col-md-2">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" v-model="form.description"  rows="5" placeholder="Description about the project" value="" class="form-control"></textarea>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" v-model="form.requirement" rows="5" placeholder="Descriptive requirements"  value="" class="form-control"></textarea>
                                </div>
                            </div>										
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">                                                                     
                                    ...
                                    <button type="button" @click="reset" class="btn btn-default ml-10">Clear</button>
                                </div>
                            </div>                                										
                        </div>                       
                 </form>
      ...
      methods: {
           ...
           onSubmit() {
                this.form.post('/api/projects')
                    .then(({data})=>{   
                        notice(this.form.notifications);                   
                        this.form.reset();                        
                        router.push({ name: 'client.project.files', params: { pid: data.id }});
