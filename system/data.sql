...
--
-- Host: localhost:3306
-- Generation Time: Sep 13, 2017 at 10:46 AM
...
DROP TABLE IF EXISTS `audit_markdowns`;
...
DROP TABLE IF EXISTS `job_holders`;
...
DROP TABLE IF EXISTS `quantity_files`;
...
DROP TABLE IF EXISTS `quantity_markdowns`;
...
(5, 'pthanh.ce@gmail.com', '$2y$10$3FKTzC2FiZMjLaPtWw3HtuYrvC0KoGPuX3RYN/6iTAyfEGDrg8..2', 'Thanh', 'Pv', '0123456789', 'QsCompanion', 1, NULL, '2017-05-09 01:22:36', '2017-08-10 09:00:27', 'pd1Sy9WsCoWyj2IMCTzcBFCK2mWM9GKeusLgaFC02hAWcvLGZRwJHO7ntdI7', NULL, 1, 1),
